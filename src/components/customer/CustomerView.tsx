        ...
        <div className="max-w-5xl mx-auto space-y-5">
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-500">
              Enter your pickup & destination, select an available car, and book with zero advance payment.
            </p>
          </div>
          ...
          <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto pt-3 mt-3 border-t border-slate-200">
              <span className="text-xs font-bold text-slate-500 shrink-0">Popular Destinations:</span>
        ...
        <div className="flex items-center justify-between border-b border-slate-200 pb-3">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Choose an available car to book or call / WhatsApp directly for quotation.
            </p>
          </div>
          <span className="text-xs font-bold px-3 py-1 bg-blue-50 text-blue-700 rounded-full border border-blue-200">
            {vehicles.filter(v => v.is_available).length} Cars Available
          </span>
        </div>
                ...
                <form onSubmit={handleBookSubmit} className="space-y-4">
                  ...
                  <div className="pt-2 flex items-center justify-between border-t border-slate-100">
                    <div className="flex items-center gap-1 text-[11px] text-slate-500">
                      ...
                      <span>Pay directly after trip</span>
                    </div>
